...
const unsigned int ILED_CURR_MAX_code = 4; 							// LED max current reqd. for application - 88 mA assuming 100mA range (This is default value)
...
long LOW_THR_HYS_HIGH; 											// Low threshold for gain 
...
extern volatile int g_OneSecondFlag; 							// Flag to indicate the HRM has generated an SNR value (This flag is set in the ISR for ADC ready  after every second)
